...
class DatosEmpleado extends Database
{
	...
	public function createEmpleadoModel($datosModel, $tabla){
		...
		INSERT INTO $tabla ( documento, n_em, a_em, eml_em, f_em, dir_em, lic_emp, lib_em, tel_em, barloc_em, id_doc, id_pens, id_eps, id_arl, id_ces, id_rh, id_rol) 
		VALUES (:documento, :n_em, :a_em, :eml_em, :f_em, :dir_em, :lic_emp, :lib_em, :tel_em, :barloc_em, :id_doc, :id_pens, :id_eps, :id_arl, :id_ces, :id_rh, :id_rol)");
		...
		$stmt->bindParam(":tel_em", $datosModel["tel_em"], PDO::PARAM_INT);
	...
	public function readEmpleadoModel($tabla){
		$stmt = Database::getConnection()->prepare("SELECT id_em, documento, n_em, a_em, eml_em, f_em, dir_em, lic_emp, lib_em, tel_em, barloc_em, id_doc, id_pens, id_eps, id_arl, id_ces, id_rh, id_rol FROM $tabla");
	...
	public function updateEmpleadoModel($datosModel, $tabla){
		$stmt = Database::getConnection()->prepare(
			...
			id_ces=:id_ces, 
			id_rh=:id_rh, 
			id_rol=:id_rol WHERE id_em = :id_em");
